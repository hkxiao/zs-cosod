...
def get_test_info(sal_mode='e'):
    ...
    elif sal_mode == 'CoSOD3k': # for speed test
        image_root = '/home/ubuntu/disk1/xhk/data/cosod_data/CoSOD3k'
        image_source = '/home/ubuntu/disk1/xhk/data/cosod_data/CoSOD3k'
    elif sal_mode == 'CoSal2015': # for speed test
        image_root = '../../data/cosod_data/CoSal2015'
        image_source = '../../data/cosod_data/CoSal2015'
    elif sal_mode == 'CoCA': # for speed test
        image_root = '../../data/cosod_data/CoCA'
        image_source = '../../data/cosod_data/CoCA'
